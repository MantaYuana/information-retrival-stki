"""
Text Processor  NLP Pipeline untuk Bahasa Indonesia
Modul untuk memuat dokumen PDF dan melakukan pra-pemrosesan teks:
  Case Folding → Tokenization → Stopword Removal → Stemming (Sastrawi)
"""
...
def load_documents(folder_path: str) -> dict[str, str]:
    ...
    Args:
        folder_path: Path ke folder yang berisi file PDF.
...
def stem_tokens(tokens: list[str]) -> list[str]:
    """Stemming setiap token ke kata dasarnya menggunakan Sastrawi."""

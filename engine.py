...
# =============================================================================
# CATATAN: Logika Boolean Retrieval Model di bawah ini sudah tidak digunakan
# oleh app.py (yang sekarang menggunakan TF-IDF model via tfidf_engine.py).
# Kode dipertahankan untuk referensi dan keperluan akademis.
# =============================================================================
